<template>
  <div class="review-box">
    <!-- 작품명 + 별점 -->
    <div class="top-row">
        <div class="basic-text">작품명</div>
        <div class="work-title">{{ title }}</div>
    </div>
    <div class="top-row">
        <div class="basic-text">제목</div>
        <input class="title-input" placeholder="리뷰 제목을 입력하세요" />
    </div>
    <div class="top-row">
        <div class="basic-text">별점</div>
        <RateFlexible v-model:rate="rating" />
    </div>

    <!-- 리뷰 내용 -->
    <textarea v-model="content" placeholder="리뷰를 작성해주세요." rows="10"></textarea>
